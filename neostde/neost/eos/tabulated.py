...
class TabulatedEoS(BaseEoS):
    ...
    def add_adm_eos(self):
        ...
        if self.adm_type == 'Dark Energy':
            ...
            number = np.linspace(1e-3,50,2000)
            self.energydensities_de = number*rho_ns  #np.logspace(-2,30,2000) #g/cm^3
            ...
            self.rho_plus = self.eos_params['rho_plus']*rho_ns 
            ...
            self.eos_de = UnivariateSpline(self.energydensities_de,
                                    self.pressures_de, k=1, s=0)
