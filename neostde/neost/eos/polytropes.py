...
class PolytropicEoS(BaseEoS):
    ...
    def add_adm_eos(self):
        ...
        if self.adm_type == 'Dark Energy':
            ...
            number = np.logspace(-2,2,2000)
            self.energydensities_de = number*rho_ns  #number*rho_ns #np.logspace(-2,30,2000) #g/cm^3
