...
def solveTOVr(double rhocent,double rho_plus, eos_eps, eos_pres, dark_energy, double atol, 
    ...
    if dark_energy == False:
        ...
        cdef double Pmin = epsilon_pressure(rho_plus, &pres_cython[0], &eps_cython[0], idx)* G * pow(c,-4)
