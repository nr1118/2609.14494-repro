...
def mass_radius_prior_plot(root_name_DE,root_name_FDM,root_name_B, root_name_BDM,ax = None):
    ...
    scatter_2 = np.loadtxt(f'{root_name_FDM}MR_prpr.txt')
    ...
    scatter_4 = np.loadtxt(f'{root_name_BDM}MR_prpr.txt')
...
Baryonic_pressures_prior = np.load(f'{root_name_B}pressures.npy')
...
Bos_min_tot = np.log10(np.load(f'{root_name_BDM}minpres.npy'))
Bos_max_tot = np.log10(np.load(f'{root_name_BDM}maxpres.npy'))
...
densities = np.log10(np.load(f'{root_name_BDM}maxpres.npy'))[:,0]   #all the same densities checked over
Bos_max_tot = np.log10(np.load(f'{root_name_BDM}maxpres.npy'))[:,2]
Ferm_max_tot = np.log10(np.load(f'{root_name_FDM}maxpres.npy'))[:,2]
Ferm_max_bar = np.log10(np.load(f'{root_name_FDM}maxpres_baryon.npy'))[:,2]
Bos_max_bar = np.log10(np.load(f'{root_name_BDM}maxpres_baryon.npy'))[:,2]
