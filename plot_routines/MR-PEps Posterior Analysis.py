...
def mass_radius_posterior_plot(root_name_DE,root_name_BDM,root_name_B, root_name_FDM,ax = None):
    ...
    scatter_2 = np.loadtxt(root_name_BDM + 'MR_prpr.txt')
    ...
    scatter_4 = np.loadtxt(root_name_FDM + 'MR_prpr.txt')
...
Bos_min_tot = np.log10(np.load(root_name_BDM + 'minpres_total.npy'))
Bos_max_tot = np.log10(np.load(root_name_BDM + 'maxpres_total.npy'))
